<div>
  ...
  [![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,react,svelte,nextjs,nodejs,express,nestjs,tailwind,prisma,postman,githubactions,sentry,nginx,grafana,git,discord,vscode,vercel,vite,supabase,planetscale,mysql,postgres,cloudflare,cypress)](https://skillicons.dev)
